...
- 프로그래밍 공부가 처음인 <strong>입문자</strong>이시거나, <strong>프론트엔드 개발자</strong>를 꿈꾸는 모든 분들에게 유익할 만한 컨텐트(포스트 및 자료)들을 모아 함께 공유합니다. 😃

- <strong>입문자</strong>를 위한 컨텐츠, <strong>취업 및 이직 준비</strong>에 도움이 될 컨텐츠가 주를 이루나, 유익하다면 어떤 IT 분야든 상관없이 공유하고자 합나다. 📙
