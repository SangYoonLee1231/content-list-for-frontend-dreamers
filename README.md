...
- <strong>프론트엔드 개발자</strong>를 꿈꾸는 모든 분들에게 유익할 만한 포스트 및 자료들을 모아 함께 공유하고자 합니다. 😃

- 개발 공부가 처음이신 <strong>입문자</strong> 분들도 모두 환영합니다. 🔥

- 주로 <strong>취업 및 이직 준비</strong>에 도움이 될 자료가 주를 이루나, 유익하다면 어떤 분야의 자료든 상관없이 공유합니다. 📙
